<?
  $title    = "Medical Waste Compliance Training Program - GIC Medical";
  $desc     = "If your staff doesn't have the latest medical waste compliance training, even the best waste disposal equipment can endanger your employees or patients";
...
<div class="contentBox mgnBI">
  <div class="contentLeft">
    <h1>Staff Safety Awareness And Medical Waste Compliance Training Program</h1>
    ...
    <div id="left">
      ...
      <p>
        ...
        correct  methodologies to take care of your facility&rsquo;s medical
        wastes. We will work  together with you to develop complete safety
        awareness among your medical staff  and employees.
      </p>
      ...
      <p>
        <strong>
          Put your confidence in GICMD to facilitate a safe and compliant waste
          disposal system in your facility.  Consult with our team of medical
          waste compliance specialists today by calling <?= $to_phone; ?>
        </strong>
      </p>
    </div>
    <br>
