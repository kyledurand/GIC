  ...
  <div class="contentLeft">
    ...
    <div class="bucket fl">
      <p class="safe">
        ...
        <span class="media__helpers--hide-before-medium">
          ...
          potentially harmful capacity to self-replicate...
        </span>
        <span class="moreInfo">
          <a href="Safety.php">More Information &gt;</a>
        </span>
      </p>
    </div>
    ...
    <div class="bucket fl">
      <p class="convenient">
        ...
        <span class="moreInfo">
          <a href="About-Us.php">More Information &gt;</a>
        </span>
      </p>
    </div>
    ...
    <div class="bucket fl clear">
      <p class="costeffective">
        ...
        <span class="media__helpers--hide-before-medium">
          ...
          quality service you expect and deserve...
        </span>
        <span class="moreInfo">
          <a href="About-Us.php">More Information &gt;</a>
        </span>
    ...
    <div class="bucket fl">
      <p class="ecofriendly">
        ...
        <span class="moreInfo">
          <a href="Eco-Friendly.php">More Information &gt;</a>
        </span>
      </p>
    </div>
